...
const CATALOG_ENTRIES = Object.freeze([
  ...
  { type: 'logistics.inventory.updated', domain: 'logistics', critical: false, version: 1 },
  { type: 'logistics.receipt.created', domain: 'logistics', critical: false, version: 1 },
  { type: 'logistics.shipment.created', domain: 'logistics', critical: false, version: 1 },
  { type: 'logistics.lot.registered', domain: 'logistics', critical: false, version: 1 },
  { type: 'logistics.stock.below_minimum', domain: 'logistics', critical: true, version: 1 },
  /** M1.1 — MES Foundation */
  { type: 'mes.production_order.created', domain: 'mes', critical: false, version: 1 },
  { type: 'mes.production.started', domain: 'mes', critical: false, version: 1 },
  { type: 'mes.production.completed', domain: 'mes', critical: false, version: 1 },
  { type: 'mes.downtime.recorded', domain: 'mes', critical: true, version: 1 },
  { type: 'mes.scrap.recorded', domain: 'mes', critical: true, version: 1 },
  { type: 'mes.oee.snapshot', domain: 'mes', critical: false, version: 1 },
  { type: 'mes.traceability.registered', domain: 'mes', critical: false, version: 1 },
  /** M1.3 — Analytics Foundation */
  { type: 'analytics.kpi.generated', domain: 'analytics', critical: false, version: 1 },
  { type: 'analytics.trend.detected', domain: 'analytics', critical: false, version: 1 },
  { type: 'analytics.forecast.generated', domain: 'analytics', critical: false, version: 1 },
  { type: 'analytics.aggregation.completed', domain: 'analytics', critical: false, version: 1 },
  { type: 'analytics.anomaly.detected', domain: 'analytics', critical: true, version: 1 },
  { type: 'analytics.threshold.breached', domain: 'analytics', critical: true, version: 1 },
