...
useRoute('/api/aioi/cockpit', './routes/aioi/aioiCockpitRoutes', requireAuth);
useRoute('/api/aioi/executive-cockpit', './routes/aioi/aioiExecutiveCockpitViewModelRoutes', requireAuth);
useRoute('/api/aioi/runtime', './routes/aioi/aioiRuntimeRoutes', requireAuth);
useRoute('/api/aioi/governance', './routes/aioi/aioiGovernanceRoutes', requireAuth);
useRoute('/api/aioi/scale', './routes/aioi/aioiScaleRoutes', requireAuth);
useRoute('/api/aioi/production', './routes/aioi/aioiProductionRoutes', requireAuth);
useRoute('/api/aioi/operations', './routes/aioi/aioiOperationsRoutes', requireAuth);
useRoute('/api/aioi/authorization', './routes/aioi/aioiAuthorizationRoutes', requireAuth);
useRoute('/api/aioi/compliance', './routes/aioi/aioiComplianceRoutes', requireAuth);
useRoute('/api/aioi/baseline', './routes/aioi/aioiBaselineRoutes', requireAuth);
useRoute('/api/aioi/assurance', './routes/aioi/aioiAssuranceRoutes', requireAuth);
useRoute('/api/aioi/recovery', './routes/aioi/aioiRecoveryRoutes', requireAuth);
useRoute('/api/aioi/release', './routes/aioi/aioiReleaseRoutes', requireAuth);
useRoute('/api/aioi/archive', './routes/aioi/aioiArchiveRoutes', requireAuth);
useRoute('/api/f49/gemini', './routes/f49/f49GeminiRoutes', requireAuth);
useRoute('/api/f49/ceo', './routes/f49/f49CeoRoutes', requireAuth);
useRoute('/api/f49/closure', './routes/audit/truthClosureRoutes', requireAuth);
useRoute('/api/operations/continuous', './routes/operations/continuousOperationRoutes', requireAuth);
useRoute('/api/operations/observation', './routes/operations/continuousOperationObservationRoutes', requireAuth);
useRoute('/api/operations/active', './routes/operations/activeContinuousOperationRoutes', requireAuth);
useRoute('/api/operations/runtime', './routes/operations/runtimeStabilizationRoutes', requireAuth);
