...
useRoute('/api/aioi/authorization', './routes/aioi/aioiAuthorizationRoutes');
useRoute('/api/aioi/compliance', './routes/aioi/aioiComplianceRoutes');
useRoute('/api/aioi/baseline', './routes/aioi/aioiBaselineRoutes');
useRoute('/api/aioi/assurance', './routes/aioi/aioiAssuranceRoutes');
useRoute('/api/aioi/recovery', './routes/aioi/aioiRecoveryRoutes');
useRoute('/api/aioi/release', './routes/aioi/aioiReleaseRoutes');
useRoute('/api/aioi/archive', './routes/aioi/aioiArchiveRoutes');
useRoute('/api/f49/gemini', './routes/f49/f49GeminiRoutes');
useRoute('/api/f49/ceo', './routes/f49/f49CeoRoutes');
useRoute('/api/f49/closure', './routes/audit/truthClosureRoutes');
useRoute('/api/operations/continuous', './routes/operations/continuousOperationRoutes');
useRoute('/api/operations/observation', './routes/operations/continuousOperationObservationRoutes');
