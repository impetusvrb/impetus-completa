...
function computeSafetyCognitiveHealth({
  specialized_ratio = 0,
  generic_ratio = 0,
  operational_focus = 0,
  usefulness = 0,
  ...
  const cognitive_density = density?.score != null ? density.score : 0.75;
  ...
  return {
    safety_cognitive_health: {
      ...
      genericity_reduction: genericity_reduction,
      cognitive_density,
...
module.exports = { computeSafetyCognitiveHealth };
