/**
 * ROTAS DE SETUP DA EMPRESA (PRÉ-MONTAGEM)
 * POST / → cria empresa no primeiro acesso
 * POST /change-password → troca de senha no primeiro acesso
 *
 * ⚠️ Não montado em server.js — apenas ficheiro presente para integração futura.
 */
