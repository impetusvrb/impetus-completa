...
const WIDGET_REGISTRY = {
  ...
  grafico_tendencia: { axes: ['eixo_operacional', 'eixo_financeiro', 'eixo_qualidade', 'eixo_laboratorial', 'eixo_humano'], minPriority: 6 },
  grafico_clima_equipe: { axes: ['eixo_humano'], minPriority: 7 },
