...
const PROVIDER_CATALOG = {
  ...
  akool: {
    ...
    display_name: 'Anam',
    logo_hint: 'anam',
    default_region_note: 'Conforme infraestrutura Anam / região do serviço contratado',
    retention_policy_pt: 'Consulte política de privacidade e termos Anam para retenção de mídia.',
