...
const DASHBOARD_PROFILES = {
  ...
  coordinator_environmental: {
    ...
    default_period: '7d',
    data_depth: 'detailed',
    visible_modules: ['dashboard', 'operational', 'proaction', 'biblioteca', 'ai', 'environment_intelligence', 'settings'],
    cards: [
      { key: 'environmental_compliance', title: 'Compliance ambiental', icon: 'alert', color: 'teal' },
      { key: 'emissions_indicator', title: 'Emissões', icon: 'trending', color: 'green' },
      { key: 'waste_management', title: 'Resíduos', icon: 'target', color: 'amber', route: '/app/environment/operational' },
      { key: 'water_consumption', title: 'Água / ETA', icon: 'activity', color: 'cyan' },
      { key: 'operational_insights', title: 'Insights ambientais', icon: 'brain', color: 'teal' },
      { key: 'department_interactions', title: 'Interações do departamento', icon: 'message', color: 'blue' }
    ],
    charts: ['trend'],
    alerts: ['critical', 'high'],
    widgets: ['ai_insights', 'recent_interactions'],
    default_filters: { sector: 'meio_ambiente' }
  },
  ...
  manager_environmental: {
    ...
    default_period: '7d',
    data_depth: 'detailed',
    visible_modules: ['dashboard', 'operational', 'proaction', 'biblioteca', 'ai', 'environment_intelligence', 'audit', 'settings'],
    cards: [
      { key: 'environmental_compliance', title: 'Compliance ambiental', icon: 'alert', color: 'teal' },
      { key: 'esg_score', title: 'Indicadores ESG', icon: 'trending', color: 'green' },
      { key: 'emissions_indicator', title: 'Emissões', icon: 'activity', color: 'amber' },
      { key: 'environmental_risks', title: 'Riscos ambientais', icon: 'alert', color: 'red' },
      { key: 'utilities_consumption', title: 'Utilidades', icon: 'target', color: 'cyan' }
    ],
    charts: ['trend'],
    alerts: ['critical', 'high', 'medium'],
    widgets: ['smart_summary', 'ai_insights', 'kpi_request'],
  ...
  supervisor_environmental: {
    ...
    visible_modules: ['dashboard', 'operational', 'proaction', 'biblioteca', 'ai', 'environment_intelligence', 'settings'],
    cards: [
      { key: 'environmental_incidents', title: 'Incidentes ambientais', icon: 'alert', color: 'red' },
      { key: 'waste_management', title: 'Resíduos', icon: 'target', color: 'amber' },
      { key: 'water_consumption', title: 'Coletas / água', icon: 'activity', color: 'cyan' },
      { key: 'pending_evidence', title: 'Evidências pendentes', icon: 'target', color: 'blue' }
    ],
    charts: ['trend'],
    alerts: ['critical', 'high', 'medium'],
    widgets: ['ai_insights', 'recent_interactions'],
...
const ROLE_AREA_TO_PROFILE = {
  ...
  diretor: {
    ...
    environmental: 'director_industrial',
    sustainability: 'director_industrial',
    environmental_health_safety: 'director_industrial',
    esg: 'director_industrial',
    utilities: 'director_industrial',
    logistics: 'director_operations',
    safety: 'director_operations',
    laboratory: 'director_industrial',
    hr: 'director_hr',
    rh: 'director_hr',
    recursos_humanos: 'director_hr',
    finance: 'director_financial',
    financeiro: 'director_financial',
    logistics: 'director_operations',
    compliance: 'director_operations',
    legal: 'director_operations',
    executive: 'ceo_executive',
    executiva: 'ceo_executive',
    diretoria: 'ceo_executive',
    presidencia: 'ceo_executive',
    safety: 'director_safety',
    environmental_health_safety: 'director_safety',
    engineering: 'director_industrial',
  ...
  gerente: {
    ...
    environmental: 'manager_environmental',
    sustainability: 'manager_environmental',
    environmental_health_safety: 'manager_environmental',
    esg: 'manager_environmental',
    utilities: 'manager_environmental',
    logistics: 'manager_logistics',
    safety: 'manager_safety',
    laboratory: 'manager_quality',
    hr: 'manager_hr',
    rh: 'manager_hr',
    finance: 'manager_financial',
    engineering: 'manager_engineering',
    compliance: 'manager_compliance',
    legal: 'manager_legal',
    operations: 'manager_operations',
    procurement: 'manager_logistics',
  ...
  coordenador: {
    ...
    environmental: 'coordinator_environmental',
    sustainability: 'coordinator_environmental',
    environmental_health_safety: 'coordinator_safety',
    esg: 'coordinator_environmental',
    utilities: 'coordinator_environmental',
    logistics: 'coordinator_logistics',
    safety: 'coordinator_safety',
    laboratory: 'coordinator_quality',
    hr: 'coordinator_hr',
    rh: 'coordinator_hr',
    finance: 'coordinator_financial',
    engineering: 'coordinator_engineering',
    compliance: 'coordinator_compliance',
    legal: 'coordinator_legal',
    operations: 'coordinator_operations',
    procurement: 'coordinator_logistics',
  ...
  supervisor: {
    ...
    environmental: 'supervisor_environmental',
    sustainability: 'supervisor_environmental',
    environmental_health_safety: 'supervisor_environmental',
    esg: 'supervisor_environmental',
    utilities: 'supervisor_environmental',
    logistics: 'supervisor_logistics',
    safety: 'supervisor_safety',
    laboratory: 'supervisor_quality',
    hr: 'supervisor_hr',
    rh: 'supervisor_hr',
    finance: 'supervisor_financial',
    engineering: 'supervisor_engineering',
    compliance: 'supervisor_compliance',
    legal: 'supervisor_legal',
    operations: 'supervisor_operations',
    procurement: 'supervisor_logistics',
...
const JOB_TITLE_TO_AREA = {
  'diretor de gestão de pessoas': 'hr',
  'diretor de gestao de pessoas': 'hr',
  'diretor de recursos humanos': 'hr',
  'diretor rh': 'hr',
  'gerente de recursos humanos': 'hr',
  'gerente de gestão de pessoas': 'hr',
  'gerente de gestao de pessoas': 'hr',
  'coordenador de recursos humanos': 'hr',
  'supervisor de recursos humanos': 'hr',
  ...
  'coordenador de seguranca do trabalho': 'safety',
  'coordenador de segurança do trabalho': 'safety',
  'coordenador sst': 'safety',
  'tecnico de seguranca do trabalho': 'safety',
  'técnico de segurança do trabalho': 'safety',
  'coordenador de meio ambiente': 'environmental',
  'coordenador ambiental': 'environmental',
  'coordenador de sustentabilidade': 'sustainability',
  ...
  'coordenador juridico': 'legal',
  'coordenador de compliance': 'compliance',
  'coordenador de logistica': 'logistics',
  'coordenador de logística': 'logistics',
  'tecnico de seguranca': 'safety',
  'técnico de segurança': 'safety',
  'tecnico de seguranca do trabalho': 'safety',
  'gerente de meio ambiente': 'environmental',
  'gerente ambiental': 'environmental',
  'supervisor de meio ambiente': 'environmental',
  'supervisor ambiental': 'environmental',
  'analista ambiental': 'environmental',
  'tecnico ambiental': 'environmental',
  'técnico ambiental': 'environmental',
...
function getProfile(profileCode) {
  if (DASHBOARD_PROFILES[profileCode]) return DASHBOARD_PROFILES[profileCode];
  try {
    const domainProfiles = require('../domainAuthority/registry/domainDashboardProfiles');
    const dp = domainProfiles.getDomainProfile(profileCode);
    if (dp) return dp;
  } catch {
    /* optional layer */
  }
  return DASHBOARD_PROFILES.operator_floor;
}
