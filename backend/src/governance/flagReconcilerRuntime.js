...
const CRITICAL_FLAGS = Object.freeze([
  ...
  'IMPETUS_AI_MODEL_REGISTRY',
  'IMPETUS_HALLUCINATION_DETECTION',
  'IMPETUS_HALLUCINATION_BLOCK',
  'IMPETUS_OBSERVABILITY_V2_ENABLED',
  'IMPETUS_APM_ENTERPRISE_ENABLED',
  'IMPETUS_APM_ENTERPRISE_MODE',
  'IMPETUS_OTEL_EXPORTER_ENABLED',
  'IMPETUS_SZ4_PERSISTENCE',
  'IMPETUS_FEDERATION_ENABLED',
  'IMPETUS_FEDERATION_MODE',
  'IMPETUS_MFA_ENABLED',
  'IMPETUS_MFA_MODE',
  'IMPETUS_RLS_ENABLED',
  'IMPETUS_RLS_MODE',
  'IMPETUS_MQTT_REAL_ENABLED',
  'IMPETUS_MQTT_REAL_MODE',
  'IMPETUS_OPCUA_REAL_ENABLED',
  'IMPETUS_OPCUA_REAL_MODE',
  'IMPETUS_MODBUS_REAL_ENABLED',
  'IMPETUS_MODBUS_REAL_MODE',
  'IMPETUS_EDGE_RUNTIME_REAL_ENABLED',
  'IMPETUS_EDGE_RUNTIME_MODE',
  'IMPETUS_INDUSTRIAL_LAB_ENABLED',
]);
