# Environment Operational Runtime — Runtime — Efluente

## Âmbito

Runtime **operacional** SGA/EHS: ETE, pH, DBO, DQO, NC, emissões, resíduos e campo — mobile-first, offline-first, scanner, evidências, eventos industriais.
