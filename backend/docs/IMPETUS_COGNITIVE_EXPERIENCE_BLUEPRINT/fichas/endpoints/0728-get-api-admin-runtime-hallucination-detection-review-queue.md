# Etapa 728 — Endpoint: GET /api/admin/runtime/hallucination-detection/review-queue
...
| **Etapa** | 728 / 1060 |
| **Método** | GET |
| **Path** | `/api/admin/runtime/hallucination-detection/review-queue` |
