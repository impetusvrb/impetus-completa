# Etapa 729 — Endpoint: POST /api/admin/runtime/hallucination-detection/false-positive
...
| **Etapa** | 729 / 1060 |
| **Método** | POST |
| **Path** | `/api/admin/runtime/hallucination-detection/false-positive` |
