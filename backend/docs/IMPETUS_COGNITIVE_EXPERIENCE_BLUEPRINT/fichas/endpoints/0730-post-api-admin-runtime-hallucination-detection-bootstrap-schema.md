# Etapa 730 — Endpoint: POST /api/admin/runtime/hallucination-detection/bootstrap-schema
...
| **Etapa** | 730 / 1060 |
| **Método** | POST |
| **Path** | `/api/admin/runtime/hallucination-detection/bootstrap-schema` |
