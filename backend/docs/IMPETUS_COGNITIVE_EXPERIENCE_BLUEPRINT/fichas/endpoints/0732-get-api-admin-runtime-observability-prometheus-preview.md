# Etapa 732 — Endpoint: GET /api/admin/runtime/observability-prometheus-preview
...
| **Etapa** | 732 / 1060 |
| **Método** | GET |
| **Path** | `/api/admin/runtime/observability-prometheus-preview` |
