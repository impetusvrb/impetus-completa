# Etapa 734 — Endpoint: POST /api/admin/runtime/sz4-persistence/bootstrap-schema
...
| **Etapa** | 734 / 1060 |
| **Método** | POST |
| **Path** | `/api/admin/runtime/sz4-persistence/bootstrap-schema` |
