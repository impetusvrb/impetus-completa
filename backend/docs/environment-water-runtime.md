# Environment Operational Runtime — Runtime — Água

## Âmbito

Runtime **operacional** SGA/EHS: água (ETA, hidrômetros, coletas), emissões, resíduos e campo — mobile-first, offline-first, scanner, evidências, eventos industriais.
