...
- Telas/rotas mapeadas (frontend): **78**
- Endpoints mapeados (backend): **1135** em **144** mounts
- Endpoints referenciados pelo frontend (api.js): **634**
- Chamadas de API distintas no cliente (api.js): **815**
...
| PulseCognitiveRh | `/app/pulse-cognitive-rh` | rh, hr_management | PrivateRoute › SetupGuard › PulseRhRouteGuard | NAO_VALIDADO | lazy-loaded |
...
| GET | `/api/admin-portal/billing-gateways` | NÃO | routes/admin/billingGateways.js | — |
| PATCH | `/api/admin-portal/billing-gateways/:provider` | NÃO | routes/admin/billingGateways.js | — |
...
| GET | `/api/admin/nexus-wallet/billing-engine/dashboard` | NÃO | routes/admin/nexusWallet.js | sim |
| GET | `/api/admin/nexus-wallet/billing-engine/reconcile` | NÃO | routes/admin/nexusWallet.js | sim |
| GET | `/api/admin/nexus-wallet/billing-ledger` | NÃO | routes/admin/nexusWallet.js | sim |
...
| POST | `/api/dashboard/chat/upload-file` | NÃO | routes/dashboard.js | sim |
...
| GET | `/api/pulse/cognitive/hr/calibration/audit` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/event-alignment` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/explainability/:userId` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/false-negatives` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/false-positives` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/insights` | sim | routes/pulseCognitive.js | sim |
| POST | `/api/pulse/cognitive/hr/calibration/insights/:insightId/validate` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/calibration/reliability` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/calibration/report` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/simulations` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/temporal-consistency` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/calibration/validations` | sim | routes/pulseCognitive.js | — |
| POST | `/api/pulse/cognitive/hr/comprehension` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/cross-domain` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/dashboard` | sim | routes/pulseCognitive.js | sim |
| POST | `/api/pulse/cognitive/hr/events` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/executive` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/explainability/:userId` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/memory/consult` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/memory/contract` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/memory/governance` | sim | routes/pulseCognitive.js | — |
| POST | `/api/pulse/cognitive/hr/memory/outcome` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/memory/similar` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/memory/timeline` | sim | routes/pulseCognitive.js | — |
| POST | `/api/pulse/cognitive/hr/reconcile` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/hr/scheduler/status` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/subject/:userId` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/temporal` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/hr/timeline` | sim | routes/pulseCognitive.js | sim |
| GET | `/api/pulse/cognitive/me/index` | sim | routes/pulseCognitive.js | — |
| GET | `/api/pulse/cognitive/meta` | sim | routes/pulseCognitive.js | — |
...
| SEC-08 Certificação | [`SECURITY_CERTIFICATION_V1.md`](./SECURITY_CERTIFICATION_V1.md) | ✅ **ENTERPRISE SECURITY V1 — CERTIFIED WITH REMARKS** |
| SEC-09 Promotion | [`SEC_09_PROMOTION.md`](./SEC_09_PROMOTION.md) | ✅ Plano aprovado |
| SEC-10 Active Defense | [`SEC_10_ACTIVE_DEFENSE.md`](./SEC_10_ACTIVE_DEFENSE.md) | ✅ Fase 1 (consultivo) |
| SEC-11 Adaptive Protection | [`SEC_11_ADAPTIVE_PROTECTION.md`](./SEC_11_ADAPTIVE_PROTECTION.md) | ✅ Fase 2 (planos) |
| SEC-12 Execution Validation | [`SEC_12_EXECUTION_VALIDATION.md`](./SEC_12_EXECUTION_VALIDATION.md) | ✅ Dry-run |
| SEC-13 Controlled Execution | [`SEC_13_CONTROLLED_EXECUTION.md`](./SEC_13_CONTROLLED_EXECUTION.md) | ✅ LOW auto |
| SEC-13A Operational Promotion | [`SEC_13A_OPERATIONAL_PROMOTION.md`](./SEC_13A_OPERATIONAL_PROMOTION.md) | ✅ ONLINE READY plan |
...
|--------------------|-----------|
| `node src/tests/audit/SEC_08_ENTERPRISE_SECURITY_CERTIFICATION.test.js` | Certificação SEC-08 (baseline) |
| `GET /api/audit/security-observatory` | Observabilidade SEC-01 |
| `GET /api/audit/security-incidents` | Observabilidade SEC-02 |
| `GET /api/audit/security-threat-intelligence` | Observabilidade SEC-03 |
| `GET /api/audit/security-runtime-integrity` | Observabilidade SEC-04 |
| `GET /api/audit/security-notifications` | Observabilidade SEC-05 |
| `GET /api/audit/security-response` | Observabilidade SEC-06 |
| `GET /api/audit/security-soc` | Observabilidade SEC-07 |
| `GET /api/audit/security-certification` | Evidência SEC-08 |
| `GET /api/audit/security-promotion` | Dashboard SEC-09 (plano + estado) |
| `GET /api/audit/security-active-defense` | Active Defense SEC-10 (consultivo) |
| `node src/tests/audit/SEC_09_ENTERPRISE_SECURITY_PROMOTION.test.js` | Auditoria SEC-09 |
| `node src/tests/securityActiveDefense/SEC_10_ACTIVE_DEFENSE.test.js` | Auditoria SEC-10 |
| `GET /api/audit/security-adaptive-protection` | Adaptive Protection SEC-11 |
| `node src/tests/securityAdaptiveProtection/SEC_11_ADAPTIVE_PROTECTION.test.js` | Auditoria SEC-11 |
| `GET /api/audit/security-execution-validation` | Execution Validation SEC-12 |
| `node src/tests/securityExecutionValidation/SEC_12_EXECUTION_VALIDATION.test.js` | Auditoria SEC-12 |
| `GET /api/audit/security-controlled-execution` | Controlled Execution SEC-13 |
| `node src/tests/securityControlledExecution/SEC_13_CONTROLLED_EXECUTION.test.js` | Auditoria SEC-13 |
| `GET /api/audit/security-operational-promotion` | Operational Promotion SEC-13A |
| `node src/tests/securityPromotionOperational/SEC_13A_OPERATIONAL_PROMOTION.test.js` | Auditoria SEC-13A |
| `GET /api/audit/security-adaptive-blocking` | Adaptive Blocking SEC-14 |
| `node src/tests/securityAdaptiveBlocking/SEC_14_ADAPTIVE_BLOCKING.test.js` | Auditoria SEC-14 |
| `GET /api/audit/security-anti-scanner` | Anti-Scanner SEC-15 |
| `node src/tests/securityAntiScanner/SEC_15_ANTI_SCANNER.test.js` | Auditoria SEC-15 |
| `GET /api/audit/security-threat-deception` | Threat Deception SEC-16 |
| `node src/tests/securityThreatDeception/SEC_16_THREAT_DECEPTION.test.js` | Auditoria SEC-16 |
| `GET /api/audit/security-exfiltration` | Exfiltration Detection SEC-17 |
| `node src/tests/securityExfiltrationDetection/SEC_17_EXFILTRATION_DETECTION.test.js` | Auditoria SEC-17 |
| `GET /api/audit/security-runtime-protection` | Runtime Protection SEC-18 |
| `node src/tests/securityRuntimeProtection/SEC_18_RUNTIME_PROTECTION.test.js` | Auditoria SEC-18 |
...
> **Event Governance v1:** infraestrutura congelada · Contrato ECO-02 certificado
...
| ECO-04 Controller | [`ECO_04_CONTROLLER_CONSUMER.md`](./ECO_04_CONTROLLER_CONSUMER.md) | ✅ Certificado com ressalvas (shadow) |
| ECO-05 Pulse | [`ECO_05_PULSE_CONSUMER.md`](./ECO_05_PULSE_CONSUMER.md) | ✅ Certificado com ressalvas (shadow) |
| ECO-06 KB + Context | [`ECO_06_CONTEXT_CONSUMER.md`](./ECO_06_CONTEXT_CONSUMER.md) | ✅ Certificado com ressalvas (shadow) |
| ECO-07 Executive dashboards | [`ECO_07_EXECUTIVE_CONSUMER.md`](./ECO_07_EXECUTIVE_CONSUMER.md) | ✅ Certificado com ressalvas (shadow) |
| ECO-08 Ecossistema | [`ECO_08_ENTERPRISE_CERTIFICATION.md`](./ECO_08_ENTERPRISE_CERTIFICATION.md) | ✅ **ENTERPRISE ECOSYSTEM CERTIFIED WITH REMARKS** |

| Comando / Endpoint | Descrição |
|--------------------|-----------|
| `node src/tests/audit/ECO_03_BYPASS_MIGRATION.test.js` | Certificação ECO-03 |
| `node src/tests/audit/ECO_04_CONTROLLER_CONSUMER.test.js` | Certificação ECO-04 |
| `node src/tests/audit/ECO_05_PULSE_CONSUMER.test.js` | Certificação ECO-05 |
| `node src/tests/audit/ECO_06_CONTEXT_CONSUMER.test.js` | Certificação ECO-06 |
| `node src/tests/audit/ECO_07_EXECUTIVE_CONSUMER.test.js` | Certificação ECO-07 |
| `node src/tests/audit/ECO_08_ENTERPRISE_ECOSYSTEM.test.js` | Certificação ECO-08 (baseline) |
| `GET /api/audit/eco-convergence/status` | Observabilidade ECO-03 |
| `GET /api/audit/eco-controller/status` | Observabilidade ECO-04 |
| `GET /api/audit/eco-pulse/status` | Observabilidade ECO-05 |
| `GET /api/audit/eco-context/status` | Observabilidade ECO-06 |
| `GET /api/audit/eco-executive/status` | Observabilidade ECO-07 |

---

## Enterprise Baseline v1 (BASELINE-LOCK-01)

> **Baseline encerrada:** 2026-07-03 · Event Governance v1 congelado · ECO shadow (flags OFF)

| Documento | Descrição |
|-----------|-----------|
| [`ENTERPRISE_BASELINE_V1.md`](./ENTERPRISE_BASELINE_V1.md) | Documento oficial baseline |
| [`BASELINE_LOCK_REPORT.md`](./BASELINE_LOCK_REPORT.md) | Relatório de encerramento |
| [`BASELINE_LOCK_MATRIX.md`](./BASELINE_LOCK_MATRIX.md) | Matriz consolidada |

| Comando | Descrição |
|---------|-----------|
| `node src/tests/audit/BASELINE_LOCK_01_ENTERPRISE.test.js` | Certificação baseline lock |
